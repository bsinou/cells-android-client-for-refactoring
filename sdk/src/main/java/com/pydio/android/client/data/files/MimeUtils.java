...
public final class MimeUtils {
     ...
     * own "content.types.user.table" means you don't drawable any of the built-ins, and the built-ins
     ...
     * MIME types map to multiple extensions. This load will return the most
